          ...
          <div class="iq-sidebar  sidebar-default ">
              <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
                  <a href="{{ route('dashboard') }}" class="header-logo">
                      <img src="{{ asset('assets/images/store.png') }}" class="img-fluid rounded-normal light-logo"
                          alt="logo">
                      <h5 class="logo-title light-logo ml-3">DagangPro</h5>
                  </a>
                              ...
                              <ul id="sale" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                      <a href="{{ route('invoice.index') }}">
                                          <i class="las la-minus"></i><span>List Invoices</span>
                                      </a>
                                  </li>
                                  {{-- <li class="">
                  ...
                  <nav class="navbar navbar-expand-lg navbar-light p-0">
                      <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                          ...
                          <a href="../backend/index.html" class="header-logo">
                              <img src="../assets/images/store.png" class="img-fluid rounded-normal" alt="logo">
                              <h5 class="logo-title ml-3">DagangPro</h5>
                                      ...
                                      <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                          <div class="card shadow-none m-0">
                                              <div class="card-body p-0 text-center">
                                                  ...
                                                  <div class="p-3">
                                                      <h5 class="mb-1">admin@gmail.com</h5>
                                                      {{-- <p class="mb-0">Since 10 march, 2020</p> --}}
                                                      <div
                                                          class="d-flex align-items-center justify-content-center mt-3">
                                                          {{-- <a href="{{ route('profile.index') }}"
                                                              class="btn border mr-2">Profile</a> --}}
                                                          {{-- <a href="{{ route('logout') }}" class="btn border">Sign
                                                              Out</a> --}}
